...
<template>
     <div class="container-fluid p-5">
                        <!-- calculation-->
                        <div class="title-bar">
                            <button class="btn btn-primary" v-on:click="showCheckout"> Go Back </button>
                        </div>
                        <!-- cart-->
                       
                                    <h4 class="card-title">Your cart</h4>
                                    <div class="lessons__item col-md-4 py-2">
                                <div class="cart">
                                    <div class="cart__item">
                                        <div class="cart__item" v-for="(item, index) in cart" :key="`cart--${index}`" >
                                            <div class="card-img-top" ><img :src="item.imgURL" alt="" width="200" height="250"></div>
